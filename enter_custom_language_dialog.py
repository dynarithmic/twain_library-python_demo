...
class EnterCustomLanguageDialog(tk.Toplevel):
    def __init__(self, parent):
        ...
        ttk.Label(main, text="Language Name:").grid(row=0, column=0, padx=(0, 8), pady=6)

        self.lang_name_var = tk.StringVar()
        self.entry = ttk.Entry(main, textvariable=self.lang_name_var, width=28)
    ...
    def on_ok(self):
        self.result = self.lang_name_var.get().strip()
        self.destroy()
